...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiError> cardNotFoundHandler(CardNotFoundException ex) {
        log.info(ex.getClass().getName());
        log.info(ex.getMessage());
    ...
    public ResponseEntity<ApiError> cardAlreadyExistsHandler(CardAlreadyExistsException ex) {
        log.info(ex.getClass().getName());
        log.info(ex.getMessage());
